$("#search-boot-icon").on({
    click: () => {
        ...
        $("#nav-fill").removeClass("show");
        $("#nav-fill").removeClass("active");
        ...
        $("#nav-fill-tab").removeClass("active");
        ...
        input: () => {
            ...
            countdownTimeout = setTimeout(() => {
                function searchData(query) {
                    if (query.length != 0) {
                        $.ajax({
                            url: '/bootstrap-icons/search/?search=' + query,
                            type: "GET",
                            dataType: "json",
                            success: function (response) {
                                ...
                                var SearchBody = $("#search_boot_icons");
                                if (data.length  != 0) {
                                    ...
                                    $("#FoundResults").show(200);
                                    $("#search_boot_icons").removeClass("flex-column");
                                    $("#search_boot_icons").addClass("flex-column");
                                    $("#search_boot_icons").removeClass("justify-content-center");
                                    $("#search_boot_icons").html(
                ...
                searchData($("#search-boot-icon").val());
