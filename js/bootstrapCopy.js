function whatIsCode(e) {
    ...
    $("#codeOfIcon").html(`
        <span class="text-secondary">&lt;</span><span class="html-tag">i</span> <span class="html-class">class</span><span class="text-secondary">="</span><span class="html-value">bi bi-<span id="code0123"></span></span><span class="text-secondary">"</span><span class="text-secondary">&gt;</span><span class="text-secondary">&lt;</span><span class="text-secondary">/</span><span class="html-tag">i</span><span class="text-secondary">&gt;</span>
        `);
    $(".preview-container").html(`<i class="bi bi-${e.getAttribute("svgIs")}"></i>`);
    $("#copyIconHere").val(`<i class="bi bi-${e.getAttribute("svgIs")}"></i>`)
    $(".popup").slideDown(200);
    $(".close-btn").click(() => {
        $(".popup").slideUp(200);
